...
export async function PUT(request, { params }) {
  try {
    ...
    // E15-01: el estado del contrato NO mueve el estado del lead.
    // Al firmar: fecha de firma, Event con los datos del contrato y fecha "Confirmada" en el calendario.
